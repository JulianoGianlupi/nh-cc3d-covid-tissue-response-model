...
plot_vrm_data_freq = 10  # Plot viral replication model data frequency (disable with 0)
...
plot_ir_data_freq = 10  # Plot immune recruitment data frequency (disable with 0)
